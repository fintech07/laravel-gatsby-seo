    ...
    let meta_data = {
      title:
        themeOptions.metaTitleOfListingProject !== undefined
          ? themeOptions.metaTitleOfListingProject + ' | ' + data_config.meta_title
            ...
            <div className="project-layout--left">
              <div className="section-content--menu">
                ...
                <ul className="menu-second">
                  <li className="m-r-10">
                    <Link to="/page/about-us" style={style_primary_color}>
                      information
                    </Link>
                  </li>
                  <li>
                    <Link to="/page/contact" style={style_primary_color}>
                      contact
                    </Link>
                  </li>
                </ul>
